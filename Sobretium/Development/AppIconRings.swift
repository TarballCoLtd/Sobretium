    ...
    var body: some View {
        VStack {
            ...
            GeometryReader { geometry in
                ZStack {
                    Ring(color: Color.teal, textColor: Color.black, progress: $seconds, divisor: 60, type: $type, text: $secondsText, tiny: false)
                        .frame(width: geometry.size.width - ((Ring.lineWidth * 10.0) + 120.0), height: geometry.size.height - ((Ring.lineWidth * 10.0) + 120.0))
                    Ring(color: Color.red, textColor: Color.black, progress: $minutes, divisor: 60, type: $type, text: $minutesText, tiny: false)
                        .frame(width: geometry.size.width - ((Ring.lineWidth * 8.0) + 90.0), height: geometry.size.height - ((Ring.lineWidth * 8.0) + 90.0))
                    Ring(color: Color.purple, textColor: Color.black, progress: $hours, divisor: 24, type: $type, text: $hoursText, tiny: false)
